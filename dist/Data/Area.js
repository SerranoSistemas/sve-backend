...
exports.FilterAreaText = exports.FilterAreaJoins = exports.AreasDropdown = exports.Areas = void 0;
...
exports.AreasDropdown = exports.Areas.map((Area) => {
    return {
        label: Area.descricao,
        value: Area.uuid,
    };
});
const FilterAreaJoins = (data, planta) => {
    if (!planta)
        return data;
...
exports.FilterAreaJoins = FilterAreaJoins;
const FilterAreaText = (data, text) => {
    if (!text)
        return data;
    var NewData = (0, Utils_1.Copy)(data);
    NewData = data.filter((Item) => {
...
exports.FilterAreaText = FilterAreaText;
