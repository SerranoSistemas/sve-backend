...
const Produto_1 = require("../Data/Produto");
...
Router.get("/", (REQ, RES) => {
    ...
    const FilteredJoins = (0, Utils_1.FilterByKey)(Produto_1.Produtos, "unidadeMedida", UnidadeMedida);
    const JoinedData = (0, Utils_1.InnerJoins)(FilteredJoins, "Produtos");
    const FilteredData = (0, Utils_1.Filter)(JoinedData, Text);
...
Router.get("/select", (REQ, RES) => {
    const Response = {
        data: (0, Utils_1.GetList)(Produto_1.Produtos),
        sucesso: true,
        mensagem: "Dados processados com sucesso",
    };
    return RES.status(200).json(Response);
...
Router.get("/:id", (REQ, RES) => {
    const data = (0, Utils_1.GetElementByID)(Produto_1.Produtos, REQ.params.id);
    RES.status(200).json({
        data: data || {},
