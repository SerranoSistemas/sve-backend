...
const EstacaoDeMedicao_1 = require("../Data/EstacaoDeMedicao");
...
Router.get("/", (REQ, RES) => {
    ...
    const FilteredData = (0, Utils_1.Filter)(EstacaoDeMedicao_1.EstacoesDeMedicao, Text);
...
Router.get("/select", (REQ, RES) => {
    const Response = {
        data: (0, Utils_1.GetList)(EstacaoDeMedicao_1.EstacoesDeMedicao),
        sucesso: true,
        mensagem: "Dados processados com sucesso",
    };
    return RES.status(200).json(Response);
...
Router.get("/:id", (REQ, RES) => {
    const data = (0, Utils_1.GetElementByID)(EstacaoDeMedicao_1.EstacoesDeMedicao, REQ.params.id);
    RES.status(200).json({
        data: data || {},
