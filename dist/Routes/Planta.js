...
Router.get("/", (REQ, RES) => {
    ...
    const FilteredData = (0, Utils_1.Filter)(Planta_1.Plantas, Text);
...
Router.get("/select", (REQ, RES) => {
    const Response = {
        data: (0, Utils_1.GetList)(Planta_1.Plantas),
        sucesso: true,
        mensagem: "Dados processados com sucesso",
    };
    return RES.status(200).json(Response);
...
Router.get("/:id", (REQ, RES) => {
    const data = (0, Utils_1.GetElementByID)(Planta_1.Plantas, REQ.params.id);
    RES.status(200).json({
        data: data || {},
