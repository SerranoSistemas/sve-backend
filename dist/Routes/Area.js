...
const Area_1 = require("../Data/Area");
...
Router.get("/", (REQ, RES) => {
    ...
    const FilteredJoins = (0, Utils_1.FilterByKey)(Area_1.Areas, "planta", Planta);
    const JoinedData = (0, Utils_1.InnerJoins)(FilteredJoins, "Areas");
...
Router.get("/select", (REQ, RES) => {
    const Response = {
        data: (0, Utils_1.GetList)(Area_1.Areas),
        sucesso: true,
        mensagem: "Dados processados com sucesso",
    };
    return RES.status(200).json(Response);
...
Router.get("/:id", (REQ, RES) => {
    const data = (0, Utils_1.GetElementByID)(Area_1.Areas, REQ.params.id);
    RES.status(200).json({
        data: data || {},
