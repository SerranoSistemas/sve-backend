...
const DepositosSAP_1 = require("../Data/DepositosSAP");
...
Router.get("/", (REQ, RES) => {
    ...
    const FilteredData = (0, Utils_1.Filter)(DepositosSAP_1.DepositosSAP, Text);
...
Router.get("/select", (REQ, RES) => {
    const Response = {
        data: (0, Utils_1.GetList)(DepositosSAP_1.DepositosSAP),
        sucesso: true,
        mensagem: "Dados processados com sucesso",
    };
    return RES.status(200).json(Response);
...
Router.get("/:id", (REQ, RES) => {
    const data = (0, Utils_1.GetElementByID)(DepositosSAP_1.DepositosSAP, REQ.params.id);
    RES.status(200).json({
        data: data || {},
