...
const ServersPIMS_1 = require("../Data/ServersPIMS");
...
Router.get("/", (REQ, RES) => {
    ...
    const FilteredData = (0, Utils_1.Filter)(ServersPIMS_1.PIMSServers, Text);
...
Router.get("/select", (REQ, RES) => {
    const Response = {
        data: (0, Utils_1.GetList)(ServersPIMS_1.PIMSServers),
        sucesso: true,
        mensagem: "Dados processados com sucesso",
    };
    return RES.status(200).json(Response);
...
Router.get("/:id", (REQ, RES) => {
    const data = (0, Utils_1.GetElementByID)(ServersPIMS_1.PIMSServers, REQ.params.id);
    RES.status(200).json({
        data: data || {},
