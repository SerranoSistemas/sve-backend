...
const OBJECT = "Unidade de Medida";
...
Router.get("/", (REQ, RES) => {
    ...
    const FilteredData = (0, Utils_1.Filter)(UnidadesDeMedida_1.UnidadesDeMedida, Text);
...
Router.get("/select", (REQ, RES) => {
    const Response = {
        data: (0, Utils_1.GetList)(UnidadesDeMedida_1.UnidadesDeMedida),
        sucesso: true,
        mensagem: "Dados processados com sucesso",
    };
    return RES.status(200).json(Response);
...
Router.get("/:id", (REQ, RES) => {
    const data = (0, Utils_1.GetElementByID)(UnidadesDeMedida_1.UnidadesDeMedida, REQ.params.id);
    RES.status(200).json({
        data: data || {},
